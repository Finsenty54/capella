...
/**
 * This is the item provider adapter for a {@link org.polarsys.capella.common.data.activity.AbstractAction} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AbstractActionItemProvider
	...
	public String getText(Object object) {
	 String[] result = new String[] { null };
		...
		//end-capella-code
			...
			//begin-capella-code
			"[" + getString("_UI_AbstractAction_type") + "]" : label; //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
			//end-capella-code
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(AbstractAction.class)) {
